...
Live Demo: [sitedotmoss.vercel.app](https://sitedotmoss.vercel.app)

`site(.)moss` is a personal portfolio, dynamic interactive dashboard, and AI experimental laboratory developed by Tinnaphop Sonsang. It brings together AI research projects, interactive web applications, data visualization tools, and a technical dev journal.
...
- Connects to a custom YOLO12 deep learning model deployed on Hugging Face Spaces (`badgaitintin/nextwbc`) via real-time Server-Sent Events (SSE) streaming.
...
- Machine Learning Integration: Hugging Face Space SSE Streaming API (`badgaitintin/nextwbc` YOLO12 Model)
